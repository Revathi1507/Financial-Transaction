...
accounts.add(new Account("A001", "Vishal Kumar", 
5000)); accounts.add(new Account("A002", "Neha 
Sharma", 7000)); 
ArrayList<TransactionRecord> transactions = new ArrayList<>(); 
FinancialTransactionService service = new FinancialTransactionService(accounts, 
transactions);  
try { 
